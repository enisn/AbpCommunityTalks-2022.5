...
namespace AbpCommunityTalks.Identity;
public class IdentityUserDataSeederContributor : IDataSeedContributor, ITransientDependency
{
    protected IIdentityUserRepository repository;

    protected IGuidGenerator guidGenerator;

    public IdentityUserDataSeederContributor(IIdentityUserRepository repository, IGuidGenerator guidGenerator)
    {
